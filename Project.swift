...
let project = Project(
    ...
    targets: [
        ...
        .target(
            ...
            bundleId: "$(PRODUCT_BUNDLE_IDENTIFIER).logic",
            sources: ["PiperTTSLogic/**"],
            dependencies: [
        ...
        .target(
            ...
            dependencies: [
                .target(name: sharedUtilsName, status: .required),
                .target(name: ttsLogicName, status: .required),
